...
public class Db_Fields {
    ...
    public final String userCartDBFields = "( `id` INT NOT NULL AUTO_INCREMENT , `id_user` INT NOT NULL , `data_comanda` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP , `produs` VARCHAR(256) NOT NULL , `pret` INT NOT NULL , PRIMARY KEY (`id`))";
